...
public class KaysaarMilitaryGarrison extends BaseIndustry implements EconomyTickListener {
...
//        int ammount=0;
//        if(isFunctional()&&market.hasIndustry(AoDIndustries.PLANETARY_DEFENCE_FORCE)&&market.getFaction().isPlayerFaction())
