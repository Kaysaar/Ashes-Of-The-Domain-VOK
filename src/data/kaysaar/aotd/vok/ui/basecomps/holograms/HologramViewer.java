...
public class HologramViewer extends ResizableComponent {
    ...
    public void render(float alphaMult) {
        ...
        GL11.glStencilFunc(GL11.GL_ALWAYS, 100, 0xFF);
        ...
        GL11.glStencilFunc(GL11.GL_EQUAL, 100, 0xFF);
        ...
        if(renderLine){
            GL11.glStencilMask(0xFF);
            GL11.glStencilFunc(GL11.GL_ALWAYS, 200, 0xFF);
            GL11.glStencilOp(GL11.GL_KEEP, GL11.GL_KEEP, GL11.GL_REPLACE);
            GL11.glColorMask(false, false, false, false);
            GL11.glEnable(GL11.GL_ALPHA_TEST);
            ...
            GL11.glColorMask(true, true, true, true);
            GL11.glStencilFunc(GL11.GL_EQUAL, 200, 0xFF);
            GL11.glStencilOp(GL11.GL_KEEP, GL11.GL_KEEP, GL11.GL_KEEP);
