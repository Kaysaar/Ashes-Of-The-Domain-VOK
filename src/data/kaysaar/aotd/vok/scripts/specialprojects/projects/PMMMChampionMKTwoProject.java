...
public class PMMMChampionMKTwoProject extends AoTDSpecialProject {
    ...
    public void createRewardSection(TooltipMakerAPI tooltip, float width) {
        tooltip.addPara("Gain " + Global.getSettings().getHullSpec("pmm_champion2").getHullNameWithDashClass()+" vessel.", Misc.getPositiveHighlightColor(), 5f);
    }
    @Override
    public boolean canAttemptStage(String stageID) {
        return getStage("pmm_champion_mk2_stage_4").isCompleted()||stageID.equals("pmm_champion_mk2_stage_4");
    }
    @Override
    ...
    public void grantReward() {
        ...
        FleetMemberAPI fleet = cargo.getMothballedShips().addFleetMember(AoTDMisc.getVaraint(Global.getSettings().getHullSpec("pmm_champion2")));
