...
public class RestorationDialog extends BasePopUpDialog {
    ...
    public void createContentForDialog(TooltipMakerAPI tooltip, float width) {
        ...
        tooltip.addPara(restoration + " of the %s will cost us %s monthly and require a constant flow of the following resources till completion:",2f, Color.ORANGE,sectionToRestore.getSpec().getName(),
