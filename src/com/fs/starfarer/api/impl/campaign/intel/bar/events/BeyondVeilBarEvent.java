...
public class BeyondVeilBarEvent extends BaseBarEventWithPerson {
    ...
    public void addPromptAndOption(InteractionDialogAPI dialog, Map<String, MemoryAPI> memoryMap) {
        ...
        text.addPara("A rough-looking veteran spacer with strange cybernetic augmentations seems to have been staring at you for while now " +
                "it's a quite unnerving...");

//		Color c = Misc.getHighlightColor();
//		c = Misc.getHighlightedOptionColor();

        dialog.getOptionPanel().addOption("Ask the stranger why are they staring at you. ", this,
                 Color.ORANGE,null);
    }
...
//		> Suggest that they read the manual then leave.
        ...
        switch (option) {
            case INIT:
                ...
                options.addOption("Your attention? What do you mean by that? ", OptionId.INTRUIGED);
                options.addOption("Suggest that " + getHeOrShe() + " mistook you for someone else.", OptionId.LEAVE);
                break;
            case INTRUIGED:
            ...
            case CONTINUE_1:
                text.addPara("\"Plenty of people out there are keeping tabs on you and what you've been doing as of late. Some look for signs of danger, threats, that sort of thing, and if there's nothing to be concerned about they just move on; others, " +
                        "like me, look deeper and think that you just might be the right person for the kind of valuable intel I have in my possession.\"");
                ...
                break;
            case CONTINUE_2:
                text.addPara("Back in the olden days, I was a part of an Hegemony Expeditionary Fleet. We had only one task, to investigate some odd signals coming from a planet far away from the Core Worlds. A simple job. At least on paper, that is." +
                        "It was supposed to be a simple, quick investigation, but when we got there it turned into complete, utter slaughter. Entire fleet of strange ships, the likes of which I have never seen before, appeared out of thin air and annihilated the entire Expedition fleet. I'm the sole survivor of this massacre. " +
                        "To this day I wonder if Command actually knew what kind of danger they were sending us into or they didn't and that's the just unfortunate result. Don't know which one is worse, to be honest.");
